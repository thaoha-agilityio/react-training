      ...
      <tbody>
        {tasks.map(
          ({
            ...
            <tr key={id} className="text-left border-b capitalize">
              ...
              {/* Status */}
              <td
                className={`p-5 text-sm ${getColorTaskStatus(status).textColor}`}
              >
                <span
              ...
              {/* Priority */}
              <td
                className={`p-5 text-sm ${getColorPriority(priority).textColor}`}
              >
                <span
